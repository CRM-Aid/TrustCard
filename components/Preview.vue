    ...
    <div :id="`Theme${theme}`">
      ...
      >
        <head>
          ...
          <meta
            name="author"
            content="TrustCard - An Open-Source Digital Business Card Generator"
          />
          <meta name="url" content="https://trustcard.crmaid.ai/" />
          <meta name="designer" content="Rahul Porel" />
          <meta
            property="og:title"
        ...
        <body id="body">
          ...
          >
            ...
            <a
              class="textColor"
              href="https://trustcard.crmaid.ai"
              target="_blank"
              rel="noopener noreferrer"
              >TrustCard</a
            >
